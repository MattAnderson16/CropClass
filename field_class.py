...
class Field:
    ...
    def harvest_crop(self,position):
        return self,self._crops.pop(position)

    def remove_animal(self,position):
        return self,self._animals.pop(position)
    ...
    while not valid:
        try:
            ...
            if 1 <= food <= 100:
                ...
                print("Value entered is invalid, please enter a value between 1 and 100")
        except ValueError:
            print("Value entered is invalid, please enter a value between 1 and 100")
    field.grow(light,food,water)
...
def add_animal_into_field(field):
    display_animal_menu()
    choice = get_menu_choice(0,2)
    if choice == 1:
        if field.add_animal(Cow("Cow")):
            print()
            print("Animal added")
            print()
        else:
        ...
        if field.add_animal(Sheep("Sheep")):
            print()
            print("Animal added")
            print()
        else:
